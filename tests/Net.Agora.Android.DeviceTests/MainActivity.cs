...
/// </remarks>
[Activity(
    Name = "com.sbokatuk.agora.android.devicetests.MainActivity",
    Label = "Net.Agora.Android Device Tests",
    MainLauncher = true)]
public class MainActivity : Activity
{
    /// <summary>The logcat tag the runner script filters on.</summary>
    private const string Tag = "AgoraE2E";

    /// <summary>
    /// The line the runner script greps for. Nothing else prints it. The marker is the same one
    /// the Net.Agora façade repository's device tests use, so the two repositories' runner
    /// scripts stay interchangeable.
    /// </summary>
    private const string DoneMarker = "AGORA_E2E_DONE";

    protected override void OnCreate(Bundle? savedInstanceState)
    {
        base.OnCreate(savedInstanceState);

        // Off the UI thread: the engine does file and network work during creation, and a
